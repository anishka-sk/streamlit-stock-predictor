...
if st.sidebar.button("Run Prediction"):
    ...
    if df is not None and not df.empty:
        ...
        fig_future.add_trace(go.Scatter(x=prediction_df['Date'], y=prediction_df['Predicted_Close'], mode='lines', name='Predicted Future', line=dict(dash='dash', color='orange')))
